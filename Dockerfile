...
RUN R -e "install.packages(c('shiny', 'readxl', 'dplyr', 'tidyverse', 'viridis', 'ggplot2', 'ggpubr', 'devtools', 'scales', 'tibble', 'hrbrthemes', 'grid', 'gridExtra', 'DT', 'RColorBrewer', 'shinydashboard'))"
